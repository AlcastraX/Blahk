...
function renderSlots() {
    ...
    for (let i = 1; i <= MAX_SLOTS ; i++) {
        ...
        div.innerHTML += `
            ...
            <span class="item-text" onclick="saveToSlot(${i}, workspace)">Save</span>
            <span class="item-text" onclick="loadFromSlot(${i}, workspace)">Load</span>
